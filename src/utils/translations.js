export const translations = {
  en: {
    ...
    // Placeholders
    teamANamePlaceholder: "Team A Name",
    teamBNamePlaceholder: "Team B Name",

    // Other
    vs: "VS",
    scoreboardSize: "Scoreboard Size",
  ...
  sr: {
    ...
    // Match controls
    matchControls: "Kontrole Utakmice",
    start: "Početak",
    pause: "Pauza",
    reset: "Resetuj",
    nextMatch: "Sledeća Utakmica",
    ...
    // Placeholders
    teamANamePlaceholder: "Ime Tima A",
    teamBNamePlaceholder: "Ime Tima B",

    // Other
    vs: "PROTIV",
    scoreboardSize: "Veličina Semafor Rezultata",
