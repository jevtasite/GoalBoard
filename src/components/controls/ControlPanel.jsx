...
const ControlPanel = ({ setPresentationMode, showResetConfirmModal, setShowResetConfirmModal, showNextMatchModal, setShowNextMatchModal, setShowSetTimeModal, setShowLanguageModal }) => {
  return (
